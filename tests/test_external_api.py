...
def test_conversion_func_rub(mock_get):
    ...
    mock_get.assert_called_once_with('GET', 'https://api.apilayer.com/exchangerates_data/convert?to=RUB&from=RUB&amount=31957.58', headers={'apikey': 'f5nyr0yF5s7ILP2eHKURQFFsR65627Sn'}, data={})
...
def test_conversion_func_usd(mock_get):
    ...
    mock_get.assert_called_once_with('GET', 'https://api.apilayer.com/exchangerates_data/convert?to=RUB&from=USD&amount=31957.58', headers={'apikey': 'f5nyr0yF5s7ILP2eHKURQFFsR65627Sn'}, data={})
